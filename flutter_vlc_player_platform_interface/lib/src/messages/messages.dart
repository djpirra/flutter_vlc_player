...
class VlcPlayerApi {
  ...
  Future<void> setSubtitleFontSize(int playerId, int fontSize) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_vlc_player_platform_interface.VlcPlayerApi.setSubtitleFontSize$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
