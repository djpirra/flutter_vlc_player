...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class SetSubtitleFontSizeMessage {
    private @NonNull Long playerId;
    ...
    private @NonNull Long fontSize;

    public @NonNull Long getFontSize() {
      return fontSize;
    }

    public void setFontSize(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"fontSize\" is null.");
      }
      this.fontSize = setterArg;
    }

    /** Constructor is non-public to enforce null safety; use Builder. */
    SetSubtitleFontSizeMessage() {}

    @Override
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      SetSubtitleFontSizeMessage that = (SetSubtitleFontSizeMessage) o;
      return playerId.equals(that.playerId) && fontSize.equals(that.fontSize);
    }

    @Override
    public int hashCode() {
      return Objects.hash(playerId, fontSize);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setFontSize(@NonNull Long setterArg) {
        this.fontSize = setterArg;
        return this;
      }

      public @NonNull SetSubtitleFontSizeMessage build() {
        SetSubtitleFontSizeMessage pigeonReturn = new SetSubtitleFontSizeMessage();
        pigeonReturn.setPlayerId(playerId);
    ...
    static @NonNull SetSubtitleFontSizeMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      SetSubtitleFontSizeMessage pigeonResult = new SetSubtitleFontSizeMessage();
      Object playerId = pigeonVar_list.get(0);
      pigeonResult.setPlayerId((Long) playerId);
      Object fontSize = pigeonVar_list.get(1);
      pigeonResult.setFontSize((Long) fontSize);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 134:
          return SetSubtitleFontSizeMessage.fromList((ArrayList<Object>) readValue(buffer));
        default:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof SetSubtitleFontSizeMessage) {
        stream.write(134);
        writeValue(stream, ((SetSubtitleFontSizeMessage) value).toList());
      } else {
  ...
  public interface VlcPlayerApi {
    ...
    void setSubtitleFontSize(@NonNull SetSubtitleFontSizeMessage msg);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable VlcPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_vlc_player_platform_interface.VlcPlayerApi.setSubtitleFontSize" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                SetSubtitleFontSizeMessage msgArg = (SetSubtitleFontSizeMessage) args.get(0);
                try {
                  api.setSubtitleFontSize(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
